...
void current_reg_val()
{
    ...
    irr[4]=' ';
    cout<<"\n irr "<<irr;
    otfile<<irr<<"  "<<j1.info[1]<<"   "<<j1.info[2]<<"    "<<j1.TTC<<"    "<<j1.LLC<<"    "<<ic+1<<"   "<<R<<"\n";
    otfile<<"\n----------------------------------------------------------------------------------------------------------\n";
...
void startexe()
{
    ...
    ic =0;
    for(ic; ic<20; ++ic ) //main loop for 10 line of mem
    {
